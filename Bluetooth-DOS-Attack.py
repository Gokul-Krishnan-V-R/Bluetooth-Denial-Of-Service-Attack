...
def printLogo():
    print('\Project Team CSICE')
    print('                            Bluetooth Hijacking Script                            ')
    print('+-------------------------------------------------------------------------+ ')
    print('|                                                                         | ')
    print("|                                                                         | ")
    print('|                      Project                                       | ')
...
def main():
    ...
    time.sleep(0.1)
    print('')
    print('\THIS SOFTWARE IS PROVIDED BY CSICE PROJECT TEAM AND WE DONT OWN THE RESPONSIBILITY FOR YOUR ACTIONS')
